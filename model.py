...
X_train, X_test, y_train, y_test = train_test_split(
    X_pca, data['target'], test_size=0.2, random_state=42)
...
ensemble_model = VotingClassifier(estimators=[
    ('xgb', XGBClassifier(subsample=0.9, n_estimators=400, min_child_weight=3,
     max_depth=9, learning_rate=0.01, gamma=0, colsample_bytree=1.0)),
